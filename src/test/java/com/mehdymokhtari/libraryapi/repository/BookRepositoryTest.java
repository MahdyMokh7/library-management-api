...
class BookRepositoryTest {
  ...
  void shouldFindBooksBySpecificationWithMultipleFilters() {
    ...
    Specification<Book> spec =
        Specification.where(BookSpecification.hasPublicationYear(2018))
  ...
  void shouldFilterByTitleAndAuthorCombined() {
    ...
    Specification<Book> spec =
        Specification.where(BookSpecification.hasTitle("Effective"))
  ...
  @Test
  void shouldReturnBooksWithDeletedFalseOnly() {
