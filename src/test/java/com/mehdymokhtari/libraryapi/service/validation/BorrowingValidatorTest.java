...
class BorrowingValidatorTest {
  ...
  @InjectMocks private BorrowingValidator borrowingValidator;
  ...
  void testValidateItemAvailable_ThrowsException() {
    ...
    assertThrows(
        BookNotAvailableException.class, () -> borrowingValidator.validateItemAvailable(item));
  }
  ...
  void testValidateItemBorrowed_ThrowsException() {
    ...
    assertThrows(
        InvalidOperationException.class, () -> borrowingValidator.validateItemBorrowed(item));
  }
  ...
  void testValidateAndGetActiveBorrowing_ThrowsException() {
    ...
    assertThrows(
        BusinessException.class, () -> borrowingValidator.validateAndGetActiveBorrowing(1L));
  }
  ...
  void testValidateItemNotAlreadyBorrowed_ThrowsException() {
    ...
    assertThrows(
        ...
        () -> borrowingValidator.validateItemNotAlreadyBorrowed(1L));
  }
}
