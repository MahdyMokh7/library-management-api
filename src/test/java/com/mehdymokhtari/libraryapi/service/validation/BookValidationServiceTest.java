...
class BookValidationServiceTest {
    ...
    void testValidateUpdateBook_Success() {
        ...
        assertDoesNotThrow(() -> validationService.validateUpdateBook(1L, mock(BookUpdateRequest.class)));
    }

    @Test
    void testValidateUpdateBook_ThrowsException() {
        when(bookRepository.existsByIdAndDeletedFalse(1L)).thenReturn(false);
        assertThrows(ResourceNotFoundException.class, () -> validationService.validateUpdateBook(1L, mock(BookUpdateRequest.class)));
    }
    ...
    void testValidateBookNotBorrowed_ThrowsException() {
        ...
        assertThrows(BookNotAvailableException.class, () -> validationService.validateBookNotBorrowed(1L));
    }
    ...
    void testValidateIsbnUniqueForUpdate_ThrowsException() {
        ...
        assertThrows(BusinessException.class, () -> validationService.validateIsbnUniqueForUpdate("123", 1L));
    }
}