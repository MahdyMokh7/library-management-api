 ...
 * Enables JPA auditing for automatic timestamp management and configures
 * CORS (Cross-Origin Resource Sharing) settings for the API.
 */
@Configuration
@EnableJpaAuditing
public class AppConfig {
     ...
     * enabling frontend applications to consume the API from different domains.
     *
