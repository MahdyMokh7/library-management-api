...
public class BookController {
    ...
    public ResponseEntity<ApiResponse<PagedResponse<BookResponse>>> getAllBooks(
        ...
        BookFilter filter = BookFilter.builder()
                ...
                .status(status != null ? com.mehdymokhtari.libraryapi.model.enums.BookStatus.valueOf(status.toUpperCase()) : null)
                .build();
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Book not found"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "Book is currently borrowed")
    })
