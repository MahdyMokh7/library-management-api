...
@Tag(name = "Borrowing Management", description = "Endpoints for managing book borrowing and returns")
public class BorrowingController {
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "Book is not available")
    })
    public ResponseEntity<ApiResponse<BorrowingRecordResponse>> borrowBook(@Valid @RequestBody BorrowRequest request) {
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Book not found"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "Book is not currently borrowed")
    })
    public ResponseEntity<ApiResponse<BorrowingRecordResponse>> returnBook(@Valid @RequestBody ReturnRequest request) {
    ...
    public ResponseEntity<ApiResponse<List<BorrowingRecordResponse>>> getBorrowingHistoryByBook(@PathVariable Long bookId) {
    ...
    public ResponseEntity<ApiResponse<List<BorrowingRecordResponse>>> getBorrowingHistoryByBorrower(@PathVariable String name) {
